...
##################################################################
#定义数组
md_num=6 #应当是自左往右为GARCH,RGARCH,RMDH,2CRMDH,HAR-RV和MMDH的预测结果
...
######################
#储存列名
colnames(MAE_mat)=c('GARCH','RGARCH','RMDH','2CRMDH','HAR-RV','MMDH')
colnames(RMSE_mat)=c('GARCH','RGARCH','RMDH','2CRMDH','HAR-RV','MMDH')
colnames(HMAE_mat)=c('GARCH','RGARCH','RMDH','2CRMDH','HAR-RV','MMDH')
colnames(HRMSE_mat)=c('GARCH','RGARCH','RMDH','2CRMDH','HAR-RV','MMDH')
colnames(AMAPE_mat)=c('GARCH','RGARCH','RMDH','2CRMDH','HAR-RV','MMDH')
...
#转换顺序
use_od=c('GARCH','RGARCH','HAR-RV','MMDH','RMDH','2CRMDH')
...
#生成LateX代码
library(stargazer)
stargazer(MAE_mat[c(13,24),], summary=FALSE, rownames=T,digits = 4) 
stargazer(RMSE_mat[c(13,24),], summary=FALSE, rownames=T,digits = 4) 
stargazer(HMAE_mat[c(13,24),], summary=FALSE, rownames=T,digits = 4) 
stargazer(HRMSE_mat[c(13,24),], summary=FALSE, rownames=T,digits = 4) 
stargazer(AMAPE_mat[c(13,24),], summary=FALSE, rownames=T,digits = 4)
